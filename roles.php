...
$con=mysqli_connect($con_params['hostname'],$con_params['username'],$con_params['password'],$con_params['dbname']);
   ...
   {
    $q = "SELECT * FROM roles WHERE id = " . $recid ;
...
$con=mysqli_connect($con_params['hostname'],$con_params['username'],$con_params['password'],$con_params['dbname']);
   ...
   else
   {
     ...
     if (isset($_POST["del"]) ) {if ($_POST["del"] == "Delete"){
       $Q="DELETE FROM roles WHERE id = " . $_POST['updateid'] ;}}
...
$Q .= $_POST['updateid'];}
     ...
     if ($_POST["tran"] == "Create"){
       $Q = "INSERT INTO roles (";$Q .= "name";$Q .= " ) VALUES (";
       $Q .= "'" . mysqli_real_escape_string($con, $name_f) . "'";
      $Q.= ")";
    }}
    $sqltext = $Q;
...
<?php if (true)
{
echo "<tr><td class='desc'>ROLE NAME</td><td></td>";
echo "<td>";
echo "<input ";
if (strlen($name_err) > 0) echo "class='err' ";echo "type='text' ";echo "name='name_i' ";echo "size='30' ";echo "Value='";echo $name_f;echo "' ";echo "maxlength='80'";echo " autofocus ";echo ">";echo "</td>";echo "<td>";
