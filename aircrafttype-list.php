...
$sql= "SELECT aircrafttype.id,a.name,aircrafttype.name FROM aircrafttype LEFT JOIN organisations a ON a.id = aircrafttype.org"; 
if ($_SESSION['org'] > 0){$sql .= " WHERE aircrafttype.org=".$_SESSION['org'];}
$sql.=" ORDER BY ";
switch ($colsort) {
 case 0:
   $sql .= "id";
