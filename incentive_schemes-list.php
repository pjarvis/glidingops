...
{
 $rownum = $rownum + 1;
  echo "<tr class='";if (($rownum % 2) == 0)echo "even";else echo "odd";  echo "'>";if (true){echo "<td class='right'>";echo "<a href='IncentiveScheme?id=";echo $row[0];echo "'>";echo $row[0];echo "</a>";echo "</td>";}
