...
$con=mysqli_connect($con_params['hostname'],$con_params['username'],$con_params['password'],$con_params['dbname']);
   ...
   {
    $q = "SELECT * FROM groups WHERE id = " . $recid ;
...
$con=mysqli_connect($con_params['hostname'],$con_params['username'],$con_params['password'],$con_params['dbname']);
   ...
   else
   {
     ...
     if (isset($_POST["del"]) ) {if ($_POST["del"] == "Delete"){
       $Q="DELETE FROM groups WHERE id = " . $_POST['updateid'] ;}}
...
$Q .= $_POST['updateid'];}
     ...
     if ($_POST["tran"] == "Create"){
       $Q = "INSERT INTO groups (";$Q .= "org";$Q .= ", name";$Q .= " ) VALUES (";
$Q.=$_SESSION['org'];       $Q.= ",";
       $Q .= "'" . mysqli_real_escape_string($con, $name_f) . "'";
      $Q.= ")";
    }}
...
<?php if (true)
{
echo "<tr><td class='desc'>Group Name</td><td></td>";
echo "<td>";
echo "<input ";
